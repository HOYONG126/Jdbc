...
public class InsertStudentApp {
	public static void main(String[] args) {
		...
		try {
			...
			//String sql="insert into student values(2000,'전우치','010-7894-5612','수원시 팔달구','02/05/08')";
			String sql="insert into student values(3000,'임꺽정','010-7894-5612','수원시 팔달구','02/03/29')";
